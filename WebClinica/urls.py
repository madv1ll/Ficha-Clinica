...
from paciente.views import NuevoSignosVitales, SignosViews, clinica, domicilio, nuevoPaciente, pacienteinicio, editarPaciente, eliminarPaciente, historial, NuevoMedico, NuevoHistorial
