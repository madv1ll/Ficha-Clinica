...
from paciente.views import NuevoSignosVitales, SignosVitalesView, clinica, domicilio, nuevoPaciente, pacienteinicio, editarPaciente, eliminarPaciente, historial, NuevoMedico, NuevoHistorial
