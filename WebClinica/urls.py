...
from paciente.views import Index, NuevoSignosVitales, SignosViews, clinica, domicilio, nuevoPaciente, pacienteinicio, editarPaciente, eliminarPaciente, historial, NuevoMedico, NuevoHistorial
...
urlpatterns = [
    ...
    path('SignosVitales/<str:rut>/', SignosViews.as_view(), name='signosVitales'),
